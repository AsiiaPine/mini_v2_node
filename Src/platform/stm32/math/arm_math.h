 ...
 */
  ...
  {
/*  q31_t r,     s;
 * without initialisation 'arm_offset_q15 test' fails  but 'intrinsic' tests pass! for armCC */
    q31_t r = 0, s = 0;
...
/*  return (sum + ((q15_t) (x >> 16) * (q15_t) y)) + ((q15_t) x * (q15_t) (y >> 16)); */
  ...
  typedef struct
  {
          ...
          q7_t *pState;           //< points to the state variable array. The array is of length
                                  // numTaps+blockSize-1.
    const q7_t *pCoeffs;          //< points to the coefficient array. The array is of length
                                  // numTaps.
  } arm_fir_instance_q7;
  ...
  typedef struct
  {
          ...
          q15_t *pState;            //< points to the state variable array. The array is of length
                                    // numTaps+blockSize-1.
    const q15_t *pCoeffs;           //< points to the coefficient array. The array is of length
                                    // numTaps.
  ...
  typedef struct
  {
          ...
          q31_t *pState;            //< points to the state variable array. The array is of length
                                    // numTaps+blockSize-1.
    const q31_t *pCoeffs;           //< points to the coefficient array. The array is of length
                                    // numTaps.
  ...
  typedef struct
  {
          ...
          float32_t *pState;    //< points to the state variable array. The array is of length
                                // numTaps+blockSize-1.
    const float32_t *pCoeffs;   //< points to the coefficient array. The array is of length
                                // numTaps.
  ...
  typedef struct
  {
          int8_t numStages;       //< number of 2nd order stages in the filter.  Overall order is
                                  // 2*numStages.
          q15_t *pState;          //< Points to the array of state coefficients.  The array is of
                                  // length 4*numStages.
  ...
  typedef struct
  {
          uint32_t numStages;      //< number of 2nd order stages in the filter.  Overall order is
                                   // 2*numStages.
          q31_t *pState;           //< Points to the array of state coefficients.  The array is of
                                   // length 4*numStages.
  ...
  typedef struct
  {
          uint32_t numStages;      //< number of 2nd order stages in the filter.  Overall order is
                                   // 2*numStages.
          float32_t *pState;       //< Points to the array of state coefficients.  The array is of
                                   // length 4*numStages.
...
void arm_mat_init_f32(
  ...
  typedef struct
  {
    ...
    const uint16_t *pBitRevTable;          // points to the bit reversal table.
          uint16_t twidCoefModifier;       // twiddle coefficient modifier that supports different
...
void arm_cfft_q31(
  ...
  typedef struct
  {
          ...
          uint8_t ifftFlagR;              //< flag that selects forward (ifftFlagR=0) or
                                          //  inverse (ifftFlagR=1) transform.
          uint8_t bitReverseFlagR;        //< flag that enables (bitReverseFlagR=1) or
                                          // disables (bitReverseFlagR=0) bit reversal of output.
          uint32_t twidCoefRModifier;     //< twiddle coefficient modifier that supports different
                                          // size FFTs with the same twiddle factor table.
  ...
  typedef struct
  {
          ...
          uint8_t ifftFlagR;                    //< flag that selects forward (ifftFlagR=0) or
                                                // inverse (ifftFlagR=1) transform.
          uint8_t bitReverseFlagR;              //< flag that enables (bitReverseFlagR=1) or
                                                // disables (bitReverseFlagR=0) bit reversal of
                                                // output.
...
arm_status arm_fir_decimate_init_f32(
  ...
  typedef struct
  {
          ...
          q63_t *pState;           // points to the array of state coefficients.
                                   // The array is of length 4*numStages.
    const q31_t *pCoeffs;          // points to the array of coefficients.
  ...
  typedef struct
  {
          uint8_t numStages;         // number of 2nd order stages in the filter.
                                     // Overall order is 2*numStages.
          float32_t *pState;         // points to the array of state coefficients.
  ...
  typedef struct
  {
          uint8_t numStages;         // number of 2nd order stages in the filter.
                                     // Overall order is 2*numStages.
          float64_t *pState;         // points to the array of state coefficients.
                                     // The array is of length 2*numStages.
    const float64_t *pCoeffs;        // points to the array of coefficients.
                                     // The array is of length 5*numStages.
...
void arm_biquad_cascade_df2T_compute_coefs_f32(
  ...
  typedef struct
  {
    ...
    const q15_t *pCoeffs;                      // points to the coefficient array.
                                               // The array is of length numStages.
  ...
  typedef struct
  {
          ...
          q31_t *pState;                       // points to the state variable array.
                                               // The array is of length numStages.
    const q31_t *pCoeffs;                      // points to the coefficient array.
                                               // The array is of length numStages.
  ...
  typedef struct
  {
          ...
          float32_t *pState;                   // points to the state variable array.
                                               // The array is of length numStages.
    const float32_t *pCoeffs;                  // points to the coefficient array.
                                               // The array is of length numStages.
 ...
 */
  ...
  typedef struct
  {
          ...
          q15_t *pkCoeffs;                     // points to the reflection coefficient array.
                                               // The array is of length numStages.
          q15_t *pvCoeffs;                     // points to the ladder coefficient array.
  ...
  typedef struct
  {
          ...
          q31_t *pState;                       // points to the state variable array.
                                               // The array is of length numStages+blockSize.
          q31_t *pkCoeffs;                     // points to the reflection coefficient array.
                                               // The array is of length numStages.
          q31_t *pvCoeffs;                     // points to the ladder coefficient array.
                                               // The array is of length numStages+1.
  ...
  typedef struct
  {
          ...
          float32_t *pState;                   // points to the state variable array.
                                               // The array is of length numStages+blockSize.
          float32_t *pkCoeffs;                 // points to the reflection coefficient array.
                                               // The array is of length numStages.
          float32_t *pvCoeffs;                 // points to the ladder coefficient array.
                                               // The array is of length numStages+1.
...
void arm_correlate_fast_q31(
 ...
 /**
  ...
  {
          uint16_t numTaps;             // number of coefficients in the filter.
          uint16_t stateIndex;          // state buffer index.
                                        // Points to the oldest sample in the state buffer.
          float32_t *pState;            // points to the state buffer array.
                                        // The array is of length maxDelay+blockSize-1.
    const float32_t *pCoeffs;           // points to the coefficient array.
                                        // The array is of length numTaps.
          uint16_t maxDelay;            // maximum offset specified by the pTapDelay array.
          int32_t *pTapDelay;           // points to the array of delay values.
                                        // The array is of length numTaps.
  ...
  typedef struct
  {
          ...
          uint16_t stateIndex;          // state buffer index.
                                        // Points to the oldest sample in the state buffer.
          q31_t *pState;                // points to the state buffer array.
                                        // The array is of length maxDelay+blockSize-1.
    const q31_t *pCoeffs;               // points to the coefficient array.
                                        // The array is of length numTaps.
          uint16_t maxDelay;            // maximum offset specified by the pTapDelay array.
  ...
  typedef struct
  {
          ...
          uint16_t stateIndex;          // state buffer index.
                                        // Points to the oldest sample in the state buffer.
          q15_t *pState;                // points to the state buffer array.
                                        // The array is of length maxDelay+blockSize-1.
    const q15_t *pCoeffs;               // points to the coefficient array.
                                        // The array is of length numTaps.
          uint16_t maxDelay;            // maximum offset specified by the pTapDelay array.
  ...
  typedef struct
  {
          ...
          uint16_t stateIndex;          // state buffer index.
                                        // Points to the oldest sample in the state buffer.
          q7_t *pState;                 // points to the state buffer array.
                                        // The array is of length maxDelay+blockSize-1.
    const q7_t *pCoeffs;                // points to the coefficient array.
                                        // The array is of length numTaps.
          uint16_t maxDelay;            // maximum offset specified by the pTapDelay array.
          int32_t *pTapDelay;           // points to the array of delay values.
                                        // The array is of length numTaps.
...
float32_t arm_yule_distance(const uint32_t *pA, const uint32_t *pB, uint32_t numberOfBools);
  ...
  */
  ...
  q31_t Y)
  {
    ...
    /* Care taken for table outside boundary */
    /* Returns zero output when values are outside table boundary */
    if (rI < 0 || rI >= (S->numCols - 1) || cI < 0 || cI >= (S->numRows - 1))
    {
      return (0);
    }
